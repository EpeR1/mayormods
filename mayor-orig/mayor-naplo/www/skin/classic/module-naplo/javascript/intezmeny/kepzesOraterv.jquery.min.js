...
$(function() {
    ...
    if ($('#isAdmin').data('isadmin') == 0) {
	$('form.kepzesOraterv table tr.rogzitett .felev2').show();
	$('form.kepzesOraterv table thead .felev2').show();
	$('form.kepzesOraterv table tr.rogzitett span.oraszam').show();
	$('form.kepzesOraterv table tr.rogzitett span.kovetelmeny').slideDown('slow');
	$('form.kepzesOraterv table thead span.oraszam').show();
	$('form.kepzesOraterv table thead span.kovetelmeny').slideDown('slow');
	$('form.kepzesOraterv input').attr('readonly', true).prop('readonly', true);
    } else {
	...
	} else if ($('#isAdmin').data('isadmin') == 1 && element.closest('tr.rogzitett').length == 1) {
